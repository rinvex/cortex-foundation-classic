    ...
    @if($model->exists)
        ...
        @if($model->created_at)
            <small>
                ...
                @if($model->createdBy && request()->user()->can('update', $model->createdBy)) {{ trans('cortex/foundation::common.by') }} 
        ...
        @if($model->updated_at)
            <small>
                ...
                @if($model->updatedBy && request()->user()->can('update', $model->updatedBy)) {{ trans('cortex/foundation::common.by') }} 
