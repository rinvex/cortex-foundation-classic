        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    @if(method_exists($resource, 'causedActivity')) <li><a href="{{ route("backend.{$type}.activities", [str_singular($type) => $resource]) }}">{{ trans('cortex/fort::common.activities') }}</a></li> @endif
