        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li><a href="{{ route("backend.{$type}.edit", [str_singular($type) => $resource]) }}">{{ trans('cortex/foundation::common.details') }}</a></li>
                    <li class="active"><a href="" href="#logs-tab" data-toggle="tab">{{ trans('cortex/foundation::common.logs') }}</a></li>
                    @if(method_exists($resource, 'causedActivity')) <li><a href="{{ route("backend.{$type}.activities", [str_singular($type) => $resource]) }}">{{ trans('cortex/foundation::common.activities') }}</a></li> @endif
