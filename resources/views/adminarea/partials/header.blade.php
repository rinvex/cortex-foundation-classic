            ...
            <div class="flex justify-between h-16">
                <div class="flex px-2 lg:px-0">
                    <div class="flex-shrink-0 flex items-center">
                        ...
                        <span class="block lg:hidden h-8 w-auto"><i class="fa fa-home"></i></span>
                        <!-- logo for regular state and mobile devices -->
                        <span class="hidden lg:block h-8 w-auto"><b>{{ config('app.name') }}</b></span>
                    </div>
                </div>
        ...
        <div x-description="Mobile menu, show/hide based on menu state." class="lg:hidden" id="mobile-menu" x-show="open" style="display: none;">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200">
                <div class="flex items-center px-4">
                    ...
                    <div class="ml-3">
                        <div class="text-base font-medium text-gray-800">{{ request()->user()->full_name }}</div>
