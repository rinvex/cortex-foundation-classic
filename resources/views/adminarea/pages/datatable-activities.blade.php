        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li><a href="{{ route("adminarea.{$type}.edit", ['resource' => $resource]) }}">{{ trans('cortex/foundation::common.details') }}</a></li>
                    <li><a href="{{ route("adminarea.{$type}.logs", ['resource' => $resource]) }}">{{ trans('cortex/foundation::common.logs') }}</a></li>
