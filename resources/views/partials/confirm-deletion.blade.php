    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="deleteConfirmationModalLabel">{{ trans('cortex/fort::common.delete_confirmation') }}</h4>
            </div>
            <div class="modal-body">
                {!! trans('cortex/fort::common.delete_confirmation_body', ['type' => $type]) !!}
            </div>
            <div class="modal-footer">
                {{ Form::open(['id' => 'delete-item-form', 'method' => 'delete']) }}
                    {{ Form::button(trans('cortex/fort::common.cancel'), ['class' => 'btn btn-default', 'data-dismiss' => 'modal']) }}
                    {{ Form::button('<i class="fa fa-trash-o"></i> '.trans('cortex/fort::common.delete'), ['class' => 'btn btn-danger', 'type' => 'submit']) }}
                {{ Form::close() }}
            </div>
        </div>
    </div>
