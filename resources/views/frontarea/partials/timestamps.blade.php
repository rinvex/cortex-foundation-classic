    ...
    @if($model->exists)
        ...
        @if($model->created_at)
            <small>
                ...
                @if($model->creator) <a href="{{ route('frontarea.users.edit', ['user' => $model->creator]) }}">{{ $model->creator->username }}</a> @endif
            </small>
        @endif
        ...
        @if($model->updated_at)
            <small>
                ...
                @if($model->updater) <a href="{{ route('frontarea.users.edit', ['user' => $model->updater]) }}">{{ $model->updater->username }}</a> @endif
            </small>
        @endif
    @endif
</div>
