...
Menu::register('adminarea.cortex.foundation.accessareas.tabs', function (MenuGenerator $menu, Accessarea $accessarea) {
    ...
    $menu->route(['adminarea.cortex.foundation.accessareas.import.logs'], trans('cortex/foundation::common.logs'))->ifCan('audit', $accessarea)->if(Route::is('adminarea.cortex.foundation.accessareas.import*'));
